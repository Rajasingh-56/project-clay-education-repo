      ...
      <div className="home">
        ...
        <div className="info">
          ...
          <div className="text-msg">
            <p>
              ...
              <br />
              Learning new skills is hard. We pair you with an elder sibling who
              will <br /> guide you through it.
            </p>
          </div>
          <div className="btns">
        ...
        <div className="right-side-img">
          ...
          <div className="pro startup-user clr-yellow">
            ...
            <div className="pro-info">
              <p className="clr-yellow">Shreyans helps you build your startup
              </p>
            </div>
          </div>
        </div>
